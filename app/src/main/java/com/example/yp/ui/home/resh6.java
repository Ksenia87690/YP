...
public class resh6 extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_resh6);

            currentRecipeId = "recipe_6";
            currentRecipeTitle = "Простой завтрак из картофеля с ";
